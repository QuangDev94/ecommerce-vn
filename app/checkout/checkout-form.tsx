...
const CheckoutForm = () => {
  ...
  // Đây là hook khởi tạo form của react-hook-form.
  // <ShippingAddress> là generic type chỉ định kiểu dữ liệu cho form —
  // tức là form sẽ có các trường tương ứng với interface hoặc type ShippingAddress.
  const shippingAddressForm = useForm<ShippingAddress>({
    resolver: zodResolver(ShippingAddressSchema),
    defaultValues: shippingAddressDefaultValue,
  })
  // : SubmitHandler<ShippingAddress>
  // Đây là kiểu hàm được khai báo rõ ràng.
  // SubmitHandler<T> là type utility do react-hook-form cung cấp.
  // T ở đây là ShippingAddress, tức là values sẽ có kiểu: ShippingAddress
        ...
        {isAddressSelected && isPaymentMethodSelected && (
          <div>
            ...
            <p className='text-xs text-center py-2'>
              ...
              <Link href='/page/privacy-policy'>privacy notece</Link> and
        ...
        <div className='md:col-span-3'>
          ...
          <div>
            {isAddressSelected && shippingAddress ? (
              <div className='gird grid-cols-1 md:grid-cols-12 my-3 pb-3'>
                          ...
                          <ul>
                            <RadioGroup
                              ...
                              {AVAILABLE_DELIVERY_DATES.map((dd) => (
                                <div className='flex' key={dd.name}>
                                  <RadioGroupItem
                                    value={dd.name}
                                    id={`address-${dd.name}`}
                                  />
